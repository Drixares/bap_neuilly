    ...
    const onSubmit = async (data: FirstAdminSchemaType) => {
        try {
            ...
            if (res?.success) {
                ...
                throw new Error(error?.message || "Les informations renseignées sont invalides");
            }
    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
                Attention, n'importe qui peut accéder à cette page 
                tant que vous n'avez pas créé le premier compte administrateur.
            </div>
        </div>
    );
}
